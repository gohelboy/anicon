...
export function IconNotebookText({ 
  ...
  return (
    ...
    >
      ...
      {/* Binding Rings */}
      <motion.path transition={{ delay: 0.1 }} d="M2 6h4" />
      <motion.path transition={{ delay: 0.2 }} d="M2 10h4" />
      <motion.path transition={{ delay: 0.3 }} d="M2 14h4" />
      <motion.path transition={{ delay: 0.4 }} d="M2 18h4" />
