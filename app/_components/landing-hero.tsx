...
function HeroIconCard({
  ...
  return (
    <div
      ...
      className={`animate-fade-up ${delayClass} icon-card flex items-center justify-center border border-[var(--card-border)] bg-[var(--surface)] p-2.5 sm:p-5 cursor-default`}
    >
      <Icon
        size={32}
...
export function LandingHero() {
  return (
    <section className="relative flex min-h-[80vh] sm:min-h-[90vh] flex-col items-center justify-center px-4 pt-20 pb-16 sm:px-8 sm:pt-24 sm:pb-20 overflow-hidden">
      {/* Background layers */}
      ...
      <div className="relative z-10 mx-auto max-w-3xl text-center">
        ...
        {/* Headline */}
        <h1 className="animate-fade-up delay-1 text-3xl font-bold tracking-tight text-white sm:text-5xl md:text-6xl lg:text-7xl leading-[1.08]">
          Install like shadcn.
          <br />
        ...
        {/* Icon strip */}
        <div className="animate-fade-up delay-4 mt-10 flex flex-wrap items-center justify-center gap-2 sm:mt-20 sm:gap-4">
